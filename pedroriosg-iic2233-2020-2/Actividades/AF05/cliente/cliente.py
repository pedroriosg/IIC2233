...
class Cliente:
    ...
    def escuchar_servidor(self):
        ...
        try:
            ...
            while self.conectado:
                msg = self.recibir()
                self.controlador.manejar_mensaje(msg)
    ...
    def enviar(self, mensaje):
        ...
        try:
            # Completar
            message = self.codificar_mensaje(mensaje)
            largo_mensaje = len(message).to_bytes(5, byteorder='little')
            self.socket_cliente.sendall(largo_mensaje + message)
