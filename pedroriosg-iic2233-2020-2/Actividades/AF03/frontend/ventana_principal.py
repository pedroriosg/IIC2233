...
class VentanaPrincipal(QMainWindow):
    ...
    def crear_botones(self):
        ...
        self.boton_t1 = QPushButton("&Tarea 1")
        self.boton_t1.clicked.connect(self.boton_tarea_clickeado)
        self.boton_t2 = QPushButton("&Tarea 2")
        self.boton_t2.clicked.connect(self.boton_tarea_clickeado)

        vbox.addWidget(self.boton_t1)
        vbox.addWidget(self.boton_t2)
    ...
    def tarea_terminada(self, info_tarea):
        ...
        # Completar
        if numero_tarea == 1:
            self.boton_t2.setEnabled(False)
        elif numero_tarea == 2:
            self.boton_t1.setEnabled(False)
